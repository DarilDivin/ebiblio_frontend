...
const DeposerMemoire = () => {
  return (
    <div className="p-2">
      <div className="h-[55vh] max-sm:h-[35vh] w-full bg-green-50 grid grid-cols-2 max-md:grid-cols-[400px_1fr] max-sm:grid-cols-1 justify-center items-center px-52 max-md:px-10 max-sm:px-12 pt-8 rounded-lg">
        <div>
          ...
          <p className="text-base max-sm:text-base max-sm:text-center font-semibold font-poppins text-primary-foreground/70 justify-self-end">Les fichiers numériques de vos mémoires doivent être en format PDF non copiable et signé par votre président du jury.</p>
        </div>
