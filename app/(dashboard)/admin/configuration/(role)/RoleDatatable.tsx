...
export function RoleDataTable<TData extends Role, TValue>({
  ...
  const handleDeleteRoles = async (memories: number[]) => {
  ...
  return (
    <div className="w-full">
      <div className="flex items-center py-4 gap-2">
        <Input
          placeholder="Filtrer par le role..."
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger>
                  ...
                  >
                    <span className="sr-only">Supprimer les roles sélectionnés</span>
                    <Trash2 className="text-white group-hover:text-destructive h-6 w-6" />
                  </Button>
                </TooltipTrigger>
                <TooltipContent>
                  <p>Supprimer les roles sélectionnés</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
