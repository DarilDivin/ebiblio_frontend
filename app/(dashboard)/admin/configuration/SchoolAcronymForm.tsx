...
import { z } from "zod";
import { updateEneaminanSubscribeAmount, updateSchoolAcronym, updateSchoolName } from "@/lib/data/configuration";
...
const SchoolAcronymForm = ({name}: {name: string}) => {
  ...
  const submitForm = async (
    ...
    await updateSchoolAcronym({school_acronym});
    mutate()
  };
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Ceci est l'acronyme de l'établissement
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
...
export default SchoolAcronymForm;
