...
import { z } from "zod";
import { updateEneaminanSubscribeAmount, updateSchoolName } from "@/lib/data/configuration";
...
const SchoolNameForm = ({name}: {name: string}) => {
  ...
  const submitForm = async (
    ...
    await updateSchoolName({school_name});
    mutate()
  };
