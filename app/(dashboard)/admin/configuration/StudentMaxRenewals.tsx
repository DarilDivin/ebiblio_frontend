          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)}>
              <FormField
                ...
                name="student_max_renewals"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Renouvellement maximale par les Etudiants</FormLabel>
                    <FormControl>
                      <Input className="outline-none focus-visible:ring-ring w-full" type="number" placeholder="500" {...field} />
                    </FormControl>
                    <FormDescription>
                      Ceci est le nombre maximale de renouvellement d'un prêt par les étudiants.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
...
export default StudentMaxRenewals